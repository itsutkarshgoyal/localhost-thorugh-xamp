...
$sq2 = "SELECT * FROM website_product";
$result = $conn->query($sq2);
$sq222 = "SELECT * FROM addnewpage";
$result212 = $conn->query($sq222);
?>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> <label class="badge badge-danger">Product List </label></h4>
                  
                  <div class="table-responsive">
                    <table class="table" border="5">
                      <thead>
                        <tr>
                          <th colspan="3"><label class="badge badge-danger">Image</label></th>
                          <th><label class="badge badge-danger">Name</label></th>
                          <th><label class="badge badge-danger">Price</label></th>
                          <th><label class="badge badge-danger">Description</label></th>                          
        ...
        if ($result->num_rows > 0) 
        {
              while ($row = $result->fetch_assoc()) 
              {
                  ...
                  ?>
                  <tr>
                      <td colspan="3"><img src="<?php echo $row['location'];?>"alt="yo" height="150" width="250" border="5" /> </td>
                      <td> <?php echo $row['name']; ?></td>
                      <td> ₹<?php echo $row['price']; ?></td>
                      <td> <?php echo $row['desciption']; ?></td>
  
                      <td>
                        <button class="update" type="submit" data-toggle="modal" data-target="#myModal2" 
                            name="edit_product" data-btn="<?php echo $row["id"]; ?>" 
                            value="<?php echo $row["id"];?>"  
                            <i class="fa fa-bars"></i>Edit
                          </button> </td>
                      <td><a><button  class="update1" type="submit" data-toggle="modal" data-btn="<?php echo $row["id"]; ?>"data-target="#myModal"value="<?php echo $row["id"];?>"  <i class="fa fa-trash"></i>Delete</button></a></td>
                  </tr>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body"><form action=/star/delete_product.php>
        ...
        <div class="modal-body">
                 ...
                 // print_r($id_product);
                  ...
                  if(isset($_POST['new']) && $_POST['new']==1)
                  {
                    $id= $_POST["we"];
                  //$id=$id_product;
                    $show="SELECT * FROM website_product where id='1' ";
                  ...
                  if (mysqli_query($conn, $update)) {
                    ...
                    <a href="\star\index.php"> </div>a><?php
         ...
         <form name="form" method="post" action="" > 
                ...
                <p>Name</p><p><input type="text" name="name" placeholder="Enter Name" 
                required value="<?php echo $row['name'];?>" /></p>
                <p>Price</p><p><input type="text" name="price" placeholder="Enter Price" 
                required value="<?php echo $row['price'];?>" /></p>
                <p>Description</p><p><input type="text" name="desciption" placeholder="Enter description" 
                required value="<?php echo $row['desciption'];?>" /></p>
                <p><input name="submit" class="btn" type="submit" value="Update" /></p>
        </form>
        <?php
       // }
        ?>
