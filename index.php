...
$sql="SELECT COUNT(*) FROM website_creation";
...
$sql2="SELECT COUNT(*) FROM website_product";
$result = $conn->query($sql2);
  if ($conn->query($sql2))
   {
    while($row = $result->fetch_assoc()){
      //echo "<pre>";print_r($row); exit;
       $totalproduct= $row["COUNT(*)"];            
      } 

    }
      else echo("Error description: " . mysqli_error($conn));
$sql2="SELECT COUNT(*) FROM website_creation where status='1'";
$result = $conn->query($sql2);
  if ($conn->query($sql2))
   {
    while($row = $result->fetch_assoc()){
      //echo "<pre>";print_r($row); exit;
       $deactiveuser= $row["COUNT(*)"];            
      } 

    }
      else echo("Error description: " . mysqli_error($conn));
       
      $sq233 = "SELECT * FROM addnewpage";
$result212 = $conn->query($sq233); 
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> 65% more active user
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                 <i class="mdi mdi-cube text-danger icon-lg"></i>
                  <div class="clearfix">
                    ...
                    <div class="float-left">
                      ...
                      <p class="mb-0 text-left">Total Users </p>
                      <p class="mb-0 text-left"><?php echo $totaluser; ?> </p>
                    </div>
                 ...
                 <i class="mdi mdi-cube text-danger icon-lg"></i>
                  <div class="clearfix">
                    ...
                    <div class="float-left">
                      ...
                      <p class="mb-0 text-left">Total products </p>
                       <p class="mb-0 text-left"><?php echo $totalproduct; ?> </p>
                    </div>
                 ...
                 <i class="mdi mdi-cube text-danger icon-lg"></i>
                  <div class="clearfix">
                    ...
                    <div class="float-left">
                      ...
                      <p class="mb-0 text-left">Deactive user </p>
                      <p class="mb-0 text-left"><?php echo $deactiveuser; ?> </p>
                    </div>
