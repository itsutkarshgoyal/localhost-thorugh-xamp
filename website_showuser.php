...
$sq2 = "SELECT * FROM website_creation";
$result = $conn->query($sq2);
$sq211 = "SELECT * FROM addnewpage";
$result212 = $conn->query($sq211);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost:81/star/website_showproduct.php">
              <i class="menu-icon mdi mdi-table"></i>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-18 grid-margin stretch-card">
              <div class="card">          
                <div class="card-body">
                  <h4 class="card-title"> <label class="badge badge-danger">User List </label></h4>
                   <div class="table-responsive">
                      <table class="table" border="5">
                      <thead>
                        <tr>
                          <th ><label class="badge badge-danger">Id</label></th>
                          <th><label class="badge badge-danger">Username</label></th>
                          <th><label class="badge badge-danger">Phone</label></th>
                          <th><label class="badge badge-danger">Status</label></th>
                          <th><label class="badge badge-danger">Creation</label></th>
                          <th><label class="badge badge-danger">Last Login</label></th>
                          <th><label class="badge badge-danger">Edit</label></th>
                          <th><label class="badge badge-danger">Delete</label></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
				if ($result->num_rows > 0) 
				{
					    ...
					    {
						    	//$derial=unserialize($row["subject"]);
                          //$str = implode(',', $derial);
                $a=$row["last_login"];
               $now = new DateTime();
                ...
                $interval = $datetime1->diff($datetime2);
					        ...
					        <tr>
					            ...
					            <td> <label class="switch"><input type="checkbox"id="<?=$row['id']?>"  name="onoffswitch" value="<?=$row['status']?>" class="js-switch" <?=$row['status'] == '0' ? 'checked' : '' ;?>/> ><span class="slider round"></span><?php// echo $row['status']; ?></label></td>
					            <td> <?php echo $row['creation']; ?></td>
					            //<td> <?php echo $interval->format(' %d days %H hours %i minutes %s seconds'); ?></td>
					            
					            <td><a onClick="javascript: return confirm('database will be updated confirm');" href="edit.php?id=<?php echo $row["id"]; ?>"><button class="btn"<i class="fa fa-bars"></i>Edit</button></a> </td>
					            <td><button class="update1"type="submit" data-toggle="modal" data-btn="<?php echo $row["id"]; ?>"data-target="#myModal5"value="<?php echo $row["id"];?>" >Delete</button></a></td>
					        </tr>
        <?php
                        }
             }
...
<div class="modal fade" id="myModal5" role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Warning</h4>
            ...
            <div class="modal-body"><form action=/star/delete.php>
          <input type="hidden" name="we1"id="ctext1" value="<?php  ;?>">
          <p>Are u sure u want to delete record</p>
        </div>
        <div class="modal-footer">
         <input type="submit" class="btn"></input></form>
  ...
  $(".update1").click(function(){ 
      ...
      console.log($('#update1').data('btn'));
      var btn_value= $(this).data('btn');
      $('#myModal5')
      .find('#ctext1').val(btn_value).end()                            
      .modal('show'); 
  });
});
                                $('input[name=onoffswitch]').click(function(){
                                        ...
                                        if (status==0) 
                                         {
                                          //var bv = $(".js-switch").val(1);
                                          $('.js-switch:checked').val(1);
                                          var checkedValue = $('.js-switch:checked').val();
                                            console.log(checkedValue);
                                         }
                                          else {
                                            //var bv  = $(".js-switch").val(0);
                                            var checkedValue = $('.js-switch:checked').val(0);
                                             console.log(checkedValue);
                                        }
                                        ...
                                        $.ajax({
                                                ...
                                                data:'id= ' + id + '&status='+checkedValue
                      });
                  });
